            ...
            extend: function(t, e, n, a) {
                ...
                try {
                    ...
                    for (r = 0; r < i.length; r++)
                        o = i[r], !n || "object" != typeof e[o] || this.isElement(e[o]) ? t[o] = e[o] : Array.isArray(e[o]) ? (t[o] || (t[o] = []),
        ...
        n.extend(e.Control.prototype, {
            ...
            handleClick: function(t) {
                ...
                if (this.callActions("beforeHandleClick", arguments),
                    this.pending = 0,
                    o = a.bound[0],
                    i = a.selector ? n.closestParent(t.target, o.config.selectors.control + a.selector, !0, o.dom.document) : a.el, !i)
        ...
        n.extend(e.Mixer.prototype, {
            ...
            evaluateHideShow: function(t, e, n, a) {
                ...
                o = i.callFilters("testResultEvaluateHideShow", t, r),
                    ...
                    o === !0 && "show" === n || o === !1 && "hide" === n ? (a.show.push(e), !e.isShown && a.toShow.push(e)) : (a.hide.push(e),
            ...
            parseMultimixArgs: function(t) {
                ...
                return !i.command.insert || i.command.insert instanceof e.CommandInsert || (i.command.insert = a.parseInsertArgs([i.command.insert]).command), !i.command.remove || i.command.remove instanceof e.CommandRemove || (i.command.remove = a.parseRemoveArgs([i.command.remove]).command), !i.command.filter || i.command.filter instanceof e.CommandFilter || (i.command.filter = a.parseFilterArgs([i.command.filter]).command), !i.command.sort || i.command.sort instanceof e.CommandSort || (i.command.sort = a.parseSortArgs([i.command.sort]).command), !i.command.changeLayout || i.command.changeLayout instanceof e.CommandChangeLayout || (i.command.changeLayout = a.parseChangeLayoutArgs([i.command.changeLayout]).command),
            ...
            applyStylesOut: function(t) {
                ...
                if (n.callActions("beforeApplyStylesOut", arguments),
                    ...
                    o && (a.push(n.writeTransitionRule("width", t.staggerIndex, t.duration)),
                        ...
                        a.push(n.writeTransitionRule("margin", t.staggerIndex, t.duration))), !t.callback)
