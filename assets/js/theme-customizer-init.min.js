...
$(function() {
    ...
    $(function() {
        ...
        a && ($("html").addClass(a),
                $('[name="app-navigation"][data-app-navigation="' + a + '"]').prop("checked", !0)),
            $('[data-app-navigation="app-navigation-light"]').on("change", function(a) {
                a.preventDefault();
                a = $(this);
    ...
    $(function() {
        ...
        a && ($("html").addClass(a),
                $('[name="app-header"][data-app-header="' + a + '"]').prop("checked", !0)),
    ...
    $(function() {
        ...
        a && ($("html").addClass(a),
                $('[name="font-family"][data-font-family="' + a + '"]').prop("checked", !0)),
