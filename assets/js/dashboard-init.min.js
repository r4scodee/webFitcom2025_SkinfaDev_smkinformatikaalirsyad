...
$(function() {
        ...
        function o(e, t) {
            $("#reportrange span").html(e.format("DD MMM YY") + " - " + t.format("DD MMM YY"))
        }
    ...
    $(document).ready(function() {
        new ApexCharts(document.querySelector("#chart-penjualan"), {
            chart: {
                height: 380,
                width: "100%",
                stacked: !1,
            ...
            colors: ["#01693a", "#a2acc7", "#E1E3EA"],
            series: [{
                name: "Penjualan Ditolak",
                type: "bar",
            ...
            xaxis: {
                categories: ["JAN/23", "FEB/23", "MAR/23", "APR/23", "MEI/23", "JUN/23", "JUL/23", "AGT/23", "SEP/23", "OKT/23", "NOV/23", "DES/23"],
                axisBorder: {
                    show: !1
                },
                axisTicks: {
...
$(document).ready(function() {
        new ApexCharts(document.querySelector("#weather-overview-donut"), {
            chart: {
                width: 328,
                type: "donut"
            },
