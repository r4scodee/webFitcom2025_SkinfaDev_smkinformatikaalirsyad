    ...
    <div class="d-md-none">
      ...
      <div class="ms-2 order-3 order-md-1 page-title">
        <h3 class="mb-0 fw-bold text-success d-flex align-items-center">
          <i class="fas fa-seedling me-2"></i> Manajemen Pengiriman
        </h3>
      </div>
      ...
      <?php else: ?>
        <div class="table-responsive">
          <table class="table table-hover mb-0 rounded-3 align-middle" id="productTable">
            <thead>
              <tr>
                <th class="px-4 py-3 fs-lg">Kode pengiriman</th>
                <th class="px-4 py-3 fs-lg">Tanggal pengiriman</th>
                <th class="px-4 py-3 fs-lg">Nopol</th>
                <th class="px-4 py-3 fs-lg">Total Qty</th>
              </tr>
            </thead>
            <tbody>
              <?php foreach ($pengiriman as $p): ?>
                <tr class="align-middle">
                  <td class="px-4 py-3 fw-medium">
                    <span class="badge bg-primary"><?= $this->e($p['kodekirim']) ?></span>
                  </td>
                  <td class="px-4 py-3 fw-medium"><?= $this->e($p['tglkirim']) ?></td>
                  <td class="px-4 py-3 fw-medium">
                    <span class="badge bg-success"><?= $this->e($p['nopol']) ?></span>
                  </td>
                  <td class="px-4 py-3 fw-medium">
                    <span class="badge bg-success"><?= $this->e($p['totalqty']) ?></span>
                  </td>
                  <td>
                    <div class="d-flex h-100 justify-content-center align-items-center gap-2">
                      <a href="<?= BASE_URL ?>pengiriman/edit/<?= htmlspecialchars($p['id']) ?>"
